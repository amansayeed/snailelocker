	...
	<header class="container-flud fix">
    	...
    	<div class="col-lg-12 col-md-12 col-sm-12 clearfix">
        	<ul class="top-right clearfix">
                ...
                <li>LANGUE</li>
                <li><a href="/" >EN</a></li>
                <li><a href="<?php bloginfo( 'url' ) ?>" class="active">FR</a></li>
            </ul> 
        </div>
    	
        <div class="col-lg-4 col-md-4 col-sm-12">
        <a href="<?php bloginfo( 'url' ) ?>"><img src="https://snailedev.omdev.ca/fr/wp-content/uploads/2019/08/logo-fr.png" class="logo" /></a>
