...
?>
    ...
    <section class="container-flud contactus-sec pdg clearfix" id="con">
    	<div class="container">
            <h2 class="title">CONTACT</h2>
            <div class="col-lg-5 col-md-5 col-sm-12">
                <h5 class="wow fadeIn">SUPPORT FRANÇAIS ET ANGLAIS</h5>
                <ul class="quick-c">
                    <li><a href="mailto:support@snaile.com">support@snaile.com</a></li>
                    <li>Support: <a href="tel:833-200-5169">833-200-5169</a><li>
                </ul>
                <h5 class="wow fadeIn">INSTALLATIONS DE DISTRIBUTION</h5>
                <address>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <h5 class="wow fadeIn">POUR LE SUPPORT <a href="/support/"> cliquez ici</a>,pour des demandes générales, veuillez remplir le formulaire ci-dessous</h5>
