<?php
/**
* best-practices Category Template
*/
...
<section class="container blog pdg clearfix">
        ...
        <?php
         $query = new WP_Query( array ( 'orderby' => 'date', 'order' => 'ASC', 'post_status' => 'publish','category_name' => 'best-practices', 'post_type' => 'post', 'posts_per_page' => 50, ) );
